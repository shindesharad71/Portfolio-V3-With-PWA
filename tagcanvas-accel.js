...
function TagCanvas(cid,lctr)
{
	...
	TagCanvas.cy = p.y;
	TagCanvas.w = c.width;
	TagCanvas.h = c.height;
	if(!TagCanvas.started) {
		window.addEventListener("MozOrientation", TagCanvas.MozOrient, true);
		window.addEventListener("deviceorientation", TagCanvas.DevOrient, true);
		AddHandler('mousemove', TagCanvas.MouseMove, null);
		AddHandler('mouseout', TagCanvas.MouseMove, null);
		AddHandler('mousedown', TagCanvas.MouseClick, null);
...
TagCanvas.DevOrient = function(o)
{
	var xw = TagCanvas.w, yh = TagCanvas.h;
	TagCanvas.mx = (o.gamma + 90.0) * xw / 180.0;
	TagCanvas.my = (o.beta + 90.0) * yh / 180.0;
};
TagCanvas.MozOrient = function(o)
{
	var xw = TagCanvas.w, yh = TagCanvas.h;
	TagCanvas.mx = (o.x + 1.0) * xw * 0.5;
	TagCanvas.my = (o.y + 1.0) * yh * 0.5;
};
